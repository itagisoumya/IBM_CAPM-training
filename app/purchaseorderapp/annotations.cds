...
annotate service.POs with @(
    UI.SelectionFields:[ //show selection fields on the screen
        PO_ID,
    ...
    UI.HeaderInfo: {
        ...
        ImageUrl: 'https://purepng.com/public/uploads/large/purepng.com-ibm-logologobrand-logoiconslogos-251519939176ka7y8.png'
    },
    UI.LineItem: [ //Brings all the columns on the screen
        {
            $Type : 'UI.DataField',
            Value : PO_ID,
        },
